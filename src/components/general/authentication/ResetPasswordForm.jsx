    ...
    <FormikProvider value={formik}>
      ...
      <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
        <div className="space-y-6">
          ...
          <button
            type="submit"
            className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
